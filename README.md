...
1. [Phase 1: Jenkins Setup](#phase-1-jenkins-setup)
    1.1 [Step 1: Launch EC2 (Ubuntu 22.04)](#step-1-launch-ec2-ubuntu-2204)
    1.2 [Step 2: CI/CD Setup](#step-2-cicd-setup)
        1.2.1 [Install Jenkins for Automation](#install-jenkins-for-automation)
        1.2.2 [Install Docker for Sonarqube installation and Container service](#install-docker-for-sonarqube-installation-and-container-service)
    1.3 [Phase 2: Security](#phase-2-security)
        1.3.1 [Install SonarQube and Trivy](#install-sonarqube-and-trivy)
        1.3.2 [Integrate SonarQube and Configure](#integrate-sonarqube-and-configure)
        1.3.3 [Install Necessary Plugins in Jenkins](#install-necessary-plugins-in-jenkins)
        1.3.4 [Configure Java and Nodejs in Global Tool Configuration](#configure-java-and-nodejs-in-global-tool-configuration)
        1.3.5 [SonarQube](#sonarqube)
        1.3.6 [Install Dependency-Check and Docker Tools in Jenkins](#install-dependency-check-and-docker-tools-in-jenkins)
        1.3.7 [Install Dependency-Check Plugin](#install-dependency-check-plugin)
        1.3.8 [Configure Dependency-Check Tool](#configure-dependency-check-tool)
        1.3.9 [Install Docker Tools and Docker Plugins](#install-docker-tools-and-docker-plugins)
        1.3.10 [Add ECR credentials for your AWS credentials](#add-ecr-credentials-for-your-aws-credentials)
        1.3.11 [Add DockerHub Credentials](#add-dockerhub-credentials)
        1.3.12 [Configure CI/CD Pipeline in Jenkins for frontend](#configure-cicd-pipeline-in-jenkins-for-frontend)
2. [Phase 3: Baston Host, EKS Cluster & ECR Setup](#phase-3-baston-host-eks-cluster--ecr-setup)
    2.1 [Prerequisites](#prerequisites)
    2.2 [Steps](#steps)
        2.2.1 [Step 1: EC2 Setup](#step-1-ec2-setup)
        2.2.2 [Step 2: Clone the Code](#step-2-clone-the-code)
        2.2.3 [Step 3: IAM Configuration](#step-3-iam-configuration)
        2.2.4 [Step 4: Install AWS CLI v2](#step-4-install-aws-cli-v2)
        2.2.5 [Step 5: Install Docker](#step-5-install-docker)
        2.2.6 [Step 6: Install kubectl](#step-6-install-kubectl)
        2.2.7 [Step 7: Install eksctl](#step-7-install-eksctl)
        2.2.8 [Step 8: Setup EKS Cluster](#step-8-setup-eks-cluster)
        2.2.9 [Step 9: Create ECR Repository](#step-9-create-ecr-repository)
        2.2.10 [Step 10: Run Manifests](#step-10-run-manifests)
        2.2.11 [Step 11: Install AWS Load Balancer](#step-11-install-aws-load-balancer)
        2.2.12 [Step 12: Deploy AWS Load Balancer Controller](#step-12-deploy-aws-load-balancer-controller)
        2.2.13 [Cleanup](#cleanup)
    2.3 [Contribution Guidelines](#contribution-guidelines)
    2.4 [Support](#support)
